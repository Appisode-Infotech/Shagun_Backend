...
table_queries = [
 ...
 `created_on` datetime ,
 `sub_events` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin ,
 `event_date` datetime ,
 `event_note` varchar(255) ,
 `event_admin` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin ,
 ...
 PRIMARY KEY (`id`),
 CONSTRAINT `event_chk_1` CHECK (json_valid(`sub_events`)),
 CONSTRAINT `event_chk_2` CHECK (json_valid(`event_admin`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
    """,
    """
