...
urlpatterns = [
    ...
    path('transactions_settlement/filter_transaction_lists/eventId=<int:event_id>/filter=<int:filter>/status=<int:status>/', filter_transaction_lists,
    ...
    path('transactions_settlement/<int:status>/<int:event_id>/', transactions_settlement, name='transactions_settlement'),
