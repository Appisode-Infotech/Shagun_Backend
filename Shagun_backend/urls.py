...
urlpatterns = [
    ...
    path('activate_deactivate_location/locationId=<int:location_id>/status<int:status>/', activate_deactivate_location,
         name='activate_deactivate_location'),
    path('activate_deactivate_bank/bankId=<int:bank_id>/status=<int:status>/', activate_deactivate_bank,
         name='activate_deactivate_bank'),
    path('activate_deactivate_users/userId=<int:user_id>/status=<int:status>/', activate_deactivate_users,
         name='activate_deactivate_users'),
    path('activate_deactivate_employee/employeeId=<int:user_id>/status=<int:status>/role=<int:role>/', activate_deactivate_employee,
    ...
    path('activate_deactivate_event_type/eventTypeId=<int:event_type_id>/status=<int:status>/', activate_deactivate_event_type,
         name='activate_deactivate_event_type'),
    path('activate_deactivate_greeting_cards/cardId=<int:card_id>/status=<int:status>/', activate_deactivate_greeting_cards,
    ...
    path('activate_deactivate_kyc/kycId=<int:kyc_id>/status=<int:status>/', activate_deactivate_kyc, name='activate_deactivate_kyc'),
    path('activate_deactivate_event/eventId=<int:event_id>/status=<int:status>/', activate_deactivate_event,
         name='activate_deactivate_event'),
    path('set_event_status/eventId=<int:event_id>/status=<int:status>/', set_event_status, name='set_event_status'),
